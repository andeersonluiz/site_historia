/// Widget responsável por exibir um card com informações do notícia (Admin - mobile).
///
/// {@category Mobile}
/// {@subCategory Widget}
// ignore: library_names
library AdminNoticeCardMobile;
...
class AdminNoticeCardMobile extends StatelessWidget {
  ...
  AdminNoticeCardMobile(this.index);
  @override
    ...
    showDialog(
        ...
        builder: (_) => new AlertDialog(
              ...
              content: new CustomText(
                "Tem certeza que deseja excluir a notícia ${notice.title}?",
