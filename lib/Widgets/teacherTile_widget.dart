            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Expanded(
                    flex:2,
                    child: AutoSizeText("$noticeText",minFontSize: 5,maxFontSize: 20,maxLines: 1, style: TextStyle(
                  ...
                  Expanded(
                    flex:7,
                    child: Center(
                      child: Text("Informations about teacher",textAlign: TextAlign.center,
                        style: TextStyle(
                  ...
                  Expanded(
                    flex:1,
                    child: Text("Status: Online/Offline",textAlign: TextAlign.end,)),
